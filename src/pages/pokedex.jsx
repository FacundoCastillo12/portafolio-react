    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Resumen</h2>
          <p>
            Este proyecto fue construido usando React JS y se utilizo la API de
            Pokeapi. Mi objetivo era aprender React y utilizar una API en React
            tanto para obtener datos como para crear un buscador de pokemones.
          </p>
